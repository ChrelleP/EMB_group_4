...
################################################################
# This is a generated script based on design: EMB_guide_design
#
...
# source EMB_guide_design_script.tcl
...
set design_name EMB_guide_design
...
proc create_root_design { parentCell } {
  ...
  # Create instance: Guide_EMB1_0, and set properties
  set block_name Guide_EMB1
  set block_cell_name Guide_EMB1_0
  if { [catch {set Guide_EMB1_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $Guide_EMB1_0 eq "" } {
...
CONFIG.PCW_WDT_WDT_IO.VALUE_SRC {DEFAULT} \
  ...
  connect_bd_net -net Guide_EMB1_0_led_out [get_bd_ports led_out] [get_bd_pins Guide_EMB1_0/led_out]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins Guide_EMB1_0/clk_200M_In] [get_bd_pins processing_system7_0/FCLK_CLK1]
  connect_bd_net -net sw_in_1 [get_bd_ports sw_in] [get_bd_pins Guide_EMB1_0/sw_in]
...
preplace port led_out -pg 1 -y -110 -defaultsOSRD
preplace port sw_in -pg 1 -y -100 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 20 -defaultsOSRD
preplace inst Guide_EMB1_0 -pg 1 -lvl 1 -y -110 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -y 90 -defaultsOSRD
preplace netloc processing_system7_0_DDR 1 1 1 NJ
preplace netloc sw_in_1 1 0 1 N
preplace netloc Guide_EMB1_0_led_out 1 1 1 N
preplace netloc processing_system7_0_FIXED_IO 1 1 1 NJ
preplace netloc processing_system7_0_FCLK_CLK0 1 0 2 0 -50 400
preplace netloc processing_system7_0_FCLK_CLK1 1 0 2 0 -170 410
levelinfo -pg 1 -20 200 430 -top -180 -bot 230
",
}
