...
--Date        : Wed Oct 26 13:14:32 2016
--Host        : Error404 running 64-bit Ubuntu 14.04.5 LTS
--Command     : generate_target EMB_guide_design.bd
--Design      : EMB_guide_design
...
entity EMB_guide_design is
  ...
  attribute CORE_GENERATION_INFO of EMB_guide_design : entity is "EMB_guide_design,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=EMB_guide_design,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=2,numReposBlks=2,numNonXlnxBlks=1,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=1,synth_mode=Global}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of EMB_guide_design : entity is "EMB_guide_design.hwdef";
end EMB_guide_design;

architecture STRUCTURE of EMB_guide_design is
  component EMB_guide_design_processing_system7_0_0 is
  port (
  ...
  end component EMB_guide_design_processing_system7_0_0;
  component EMB_guide_design_Guide_EMB1_0_0 is
  port (
    clk_200M_In : in STD_LOGIC;
    sw_in : in STD_LOGIC;
    led_out : out STD_LOGIC
  );
  end component EMB_guide_design_Guide_EMB1_0_0;
  signal Guide_EMB1_0_led_out : STD_LOGIC;
...
begin
  led_out <= Guide_EMB1_0_led_out;
  sw_in_1 <= sw_in;
Guide_EMB1_0: component EMB_guide_design_Guide_EMB1_0_0
     port map (
      clk_200M_In => processing_system7_0_FCLK_CLK1,
      led_out => Guide_EMB1_0_led_out,
      sw_in => sw_in_1
    );
processing_system7_0: component EMB_guide_design_processing_system7_0_0
     port map (
