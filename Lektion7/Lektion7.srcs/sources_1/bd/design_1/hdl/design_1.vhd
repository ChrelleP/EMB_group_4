...
architecture STRUCTURE of design_1 is
  ...
  component design_1_ui_0_0 is
  port (
    duty_out : out STD_LOGIC_VECTOR ( 7 downto 0 );
    reset_out : out STD_LOGIC
  );
  end component design_1_ui_0_0;
  ...
  signal NLW_pwm_generator_0_pwm_out_UNCONNECTED : STD_LOGIC;
  signal NLW_ui_0_duty_out_UNCONNECTED : STD_LOGIC_VECTOR ( 7 downto 0 );
begin
  in_a_1 <= in_a;
  in_b_1 <= in_b;
...
ui_0: component design_1_ui_0_0
     port map (
      duty_out(7 downto 0) => NLW_ui_0_duty_out_UNCONNECTED(7 downto 0),
      reset_out => ui_0_reset_out
    );
end STRUCTURE;
