...
proc create_root_design { parentCell } {
  ...
  set block_name ClockInverter
  set block_cell_name ClockInverter_0
  if { [catch {set ClockInverter_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $ClockInverter_0 eq "" } {
...
CONFIG.PCW_WDT_WDT_IO.VALUE_SRC {DEFAULT} \
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins Debounce_0/clk_in] [get_bd_pins processing_system7_0/FCLK_CLK1]
  connect_bd_net -net sw_in_1 [get_bd_ports sw_in] [get_bd_pins Debounce_0/sw_in]
