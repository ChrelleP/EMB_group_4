...
HD_PWD='/home/exchizz/SDU/Skole/7.Semester/EMB1/VHDL/EMB_group_4/Lab5/Lab5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab5_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source Lab5_wrapper.tcl -notrace
