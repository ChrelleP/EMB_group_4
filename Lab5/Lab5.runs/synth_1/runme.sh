...
HD_PWD='/home/exchizz/SDU/Skole/7.Semester/EMB1/VHDL/EMB_group_4/Lab5/Lab5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab5_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Lab5_wrapper.tcl
